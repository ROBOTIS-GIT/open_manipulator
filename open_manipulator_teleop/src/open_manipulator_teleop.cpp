...
void OM_TELEOP::printText()
{
  ...
  printf("\n");
  printf("j1+ : decrease z axis in cartesian space\n");
  printf("j1- : decrease z axis in cartesian space\n");
  printf("j2+ : decrease z axis in cartesian space\n");
  printf("j2- : decrease z axis in cartesian space\n");
  printf("j3+ : decrease z axis in cartesian space\n");
  printf("j3- : decrease z axis in cartesian space\n");
  printf("j4+ : decrease z axis in cartesian space\n");
  printf("j4- : decrease z axis in cartesian space\n");
  printf("\n");
