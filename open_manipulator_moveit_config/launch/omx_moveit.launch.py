...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .robot_description_semantic(Path("config") / "omx" / "omx.srdf")
        .joint_limits(Path("config") / "omx" / "joint_limits.yaml")
        .trajectory_execution(Path("config") / "omx" / "moveit_controllers.yaml")
        .robot_description_kinematics(Path("config") / "omx" / "kinematics.yaml")
        .to_moveit_configs()
    )
