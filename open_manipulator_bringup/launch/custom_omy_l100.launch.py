...
#
# Real-hardware bringup for the link-shortened custom_omy_l100 robot.
...
def generate_launch_description():
    ...
    # Generate URDF file using xacro (link-shortened custom_omy_l100 variant)
    urdf_file = Command([
    ...
    # only link origins were shortened for the custom hardware)
