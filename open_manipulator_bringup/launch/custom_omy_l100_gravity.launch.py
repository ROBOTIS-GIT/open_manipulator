...
#
# Gravity-compensation bringup for the link-shortened custom_omy_l100 robot.
# Runs the arm hand-backdrivable (effort control) and mirrors it live in rviz.
