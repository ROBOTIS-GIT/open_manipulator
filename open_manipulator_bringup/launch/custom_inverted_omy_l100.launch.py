...
#
# Real-hardware bringup for the link-shortened, ceiling-mounted custom_inverted_omy_l100 robot
# (base rotated 180 deg about X vs. the floor-mounted custom_omy_l100 original).
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            'port_name',
            default_value='/dev/omy_l100_1',
            description='Port name for hardware connection (udev alias; override for the unit actually mounted upside-down).',
        ),
        DeclareLaunchArgument(
            'init_position',
            default_value='false',
    ...
    # Generate URDF file using xacro (link-shortened, ceiling-mount custom_inverted_omy_l100 variant)
    urdf_file = Command([
        ...
        PathJoinSubstitution([
            ...
            'urdf',
            'omy_l100',
            'custom_inverted_omy_l100.urdf.xacro',
        ]),
        ' ',
        'prefix:=',
        prefix,
    ...
    # only link origins were shortened and the base orientation flipped)
