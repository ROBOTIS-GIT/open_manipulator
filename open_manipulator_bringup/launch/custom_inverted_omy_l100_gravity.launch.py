...
#
# Gravity-compensation bringup for the link-shortened, ceiling-mounted
# custom_inverted_omy_l100 robot. Runs the arm hand-backdrivable (effort control)
# and mirrors it live in rviz.
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            ...
            description='Port name for hardware connection (udev alias for unit 1, stable across ttyUSB renumbering).',
        ),
        DeclareLaunchArgument(
            'ros2_control_type',
    ...
    # unchanged, only link origins were shortened and the base orientation flipped)
