...
def generate_launch_description():
    ...
    urdf_file = Command([
        ...
        ' ',
        PathJoinSubstitution([FindPackageShare('open_manipulator_description'), 'urdf', 'om_x', 'open_manipulator_x_follower.urdf.xacro']),
        ' ',
        'prefix:=', prefix,
        ' ',
        'use_sim:=', use_sim,
    ...
    controller_manager_config = PathJoinSubstitution([
        FindPackageShare('open_manipulator_bringup'), 'config', 'om_x_follower', 'hardware_controller_manager.yaml'
    ])
