...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config/open_manipulator_x'),
            glob('config/open_manipulator_x/*')),
        (os.path.join('share', package_name, 'config/omx6_follower_ai'),
            glob('config/omx6_follower_ai/*')),
        (os.path.join('share', package_name, 'config/omx6_leader_ai'),
            glob('config/omx6_leader_ai/*')),
