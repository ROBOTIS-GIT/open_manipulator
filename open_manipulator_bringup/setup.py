...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config/open_manipulator_x'),
            glob('config/open_manipulator_x/*')),
        (os.path.join('share', package_name, 'config/omx_follower_ai'),
            glob('config/omx_follower_ai/*')),
        (os.path.join('share', package_name, 'config/omx_leader_ai'),
            glob('config/omx_leader_ai/*')),
