    ...
    std::thread([this, repeatCount]()
    {
      ...
      for (int repeat = 0; repeat < repeatCount; ++repeat)
      {
        ...
        for (int row = 0; row < rowCount; ++row)
        {
          ...
          { tableWidget->item(row, 7)->setText("Pending"); }, Qt::QueuedConnection);
        }
          ...
          while (std::getline(file, line))
          {
            ...
            if (joint_angle.size() == 7)
            {
              ...
              QMetaObject::invokeMethod(this, [this, row]()
              {
                ...
                tableWidget->item(row, 7)->setText("Executing..."); }, Qt::QueuedConnection);
              ...
              QMetaObject::invokeMethod(this, [this, row]()
              {
                ...
                tableWidget->item(row, 7)->setText("Done"); }, Qt::QueuedConnection);
